...
class S {
  ...
  /// `Get password link`
  String get getPasswordInstruction {
    return Intl.message(
      'Please enter your email address below to get a password reset link.',
      name: 'getPasswordInstruction',
      desc: '',
      args: [],
    );
  }
  ...
  /// `password_changeSuccess`
  String get password_changeSuccess {
    return Intl.message(
      'The password has been reset successfully',
      name: 'password_changeSuccess',
      desc: '',
      args: [],
    );
  }
  ...
  String get includesDeliveryFee {
    return Intl.message(
      'Includes delivery fee',
      name: 'includesDeliveryFee',
      desc: '',
      args: [],
    );
  }
  ...
  String get storedPaymentMethods {
    return Intl.message(
      'Stored Payment Methods',
  ...
  String get newsletterSubscriptions {
    return Intl.message(
      'Newsletter Subscriptions',
  ...
  String get returnMerchandiseAuthorization {
    return Intl.message(
      'Return Merchandise Authorization',
