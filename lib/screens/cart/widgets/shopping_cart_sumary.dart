...
class ShoppingCartSummary extends StatefulWidget {
  ...
  const ShoppingCartSummary({this.showPrice = true,this.enableCoupon = true});
...
//      print(e.toString());
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CartModel>(builder: (context, cartModel, child) {
     ...
     // final enableCoupon = kAdvanceConfig.enableCouponCode && !cartModel.isWalletCart();
          ...
          children: <Widget>[
                      ...
                      child: Container(
                        ...
                        child: GestureDetector(
                          ...
                          child: AbsorbPointer(
                            ...
                            child: Container(
                              margin: getMargin(top: 13, left: 0, right: 8),
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding: getPadding(top: 5, left: 25, right: 25),
                    child: Text(
                      S.of(context).orderSummary,
                      overflow: TextOverflow.ellipsis,
                      textAlign: TextAlign.left,
                      style: AppStyle.txtArchivoSemiBold18Black900.copyWith(
                        color: Theme.of(context).colorScheme.onPrimary,
                        fontSize: 18,
                      ),
                    ),
