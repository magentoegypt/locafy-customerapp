...
import 'package:magentoegypt/ajstoreui/theme/app_decoration.dart';
...
import 'package:magentoegypt/screens/products/barcode_scanner_zoom.dart';
    ...
    return AppBar(
      ...
      leading: Navigator.of(context).canPop()
          ? AppbarImage(
              ...
              margin: getMargin(left: 16, top: 18, bottom: 18, right: 10),
              onTap: () {
      ...
      actions: [
        IconButton(
          ...
          onPressed: () {
            ...
            //   context,
            //   MaterialPageRoute(
            //     builder: (context) => SearchProductByQrCodeScan(),
            //   ),
            // );
