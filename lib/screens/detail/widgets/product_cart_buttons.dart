...
import 'AddToBagSheet.dart';

class ProductCartButtons extends StatefulWidget {
  final Product? product;
  final Function? onSelectVariantImage;
  final int defaultQuantity;
  final bool isBuyNow;

  const ProductCartButtons(this.product,
      {super.key, this.onSelectVariantImage, this.defaultQuantity = 1, this.isBuyNow = false});

  @override
  // ignore: no_logic_in_create_state
  State<ProductCartButtons> createState() => _StateProductVariant(product!);
}

class _StateProductVariant extends State<ProductCartButtons> {
  Product product;
