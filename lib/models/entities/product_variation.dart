...
class ProductVariation {
  ...
  ProductVariation.fromMagentoJson(
    ...
    final mediaGalleryEntries = parsedJson['media_gallery_entries'];
    if (mediaGalleryEntries != null) {
      for (var item in mediaGalleryEntries) {
        allimages.add(item['file']);
      }
    }
    attributeImage = getCustomAttribute(
        parsedJson['custom_attributes'], 'image');

    materialcolor = getCustomAttribute(
        parsedJson['custom_attributes'], 'Materialcolor');
